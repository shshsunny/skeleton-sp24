...
public class LinkedListDeque61BTest {
    ...
    public void removeFirstAndLastTest() {
        ...
        lld1.addLast("apple");
        lld1.addLast("are");
        lld1.addLast("arbitrary");
        String res = lld1.removeFirst();
        assertThat(lld1.toList()).containsExactly("and", "apple", "are", "arbitrary").inOrder();
        assertThat(res).isEqualTo("arrow");
        res = lld1.removeFirst();
        assertThat(lld1.toList()).containsExactly("apple", "are", "arbitrary").inOrder();
        assertThat(res).isEqualTo("and");
        res = lld1.removeLast();
        assertThat(lld1.toList()).containsExactly("apple", "are").inOrder();
    ...
    public void getTest() {
        ...
        lld1.addLast("are");
        lld1.addLast("arbitrary");
        String res = lld1.get(1);
        assertThat(lld1.toList()).containsExactly("arrow", "and", "apple", "are", "arbitrary").inOrder();
        assertThat(res).isEqualTo("and");
        res = lld1.get(5);
        assertThat(res).isEqualTo(null);
        res = lld1.get(-1);
    ...
    public void getRecursiveTest() {
        ...
        lld1.addLast("are");
        lld1.addLast("arbitrary");
        String res = lld1.getRecursive(1);
        assertThat(lld1.toList()).containsExactly("arrow", "and", "apple", "are", "arbitrary").inOrder();
        assertThat(res).isEqualTo("and");
