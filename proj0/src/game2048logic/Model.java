...
public class Model {
    ...
    public boolean atLeastOneMoveExists() {
        if (emptySpaceExists())
            return true;
        // in the following code there won't exist empty tiles
        for (int i = 0; i < board.size(); ++i)
    ...
    public void moveTileUpAsFarAsPossible(int x, int y) {
        ...
        // Tasks 5, 6, and 10. Fill in this function.
        while (targetY < board.size() - 1
            ...
            targetY++;
            if (board.tile(x, targetY) != null) // if the tile is already moved into a non-empty place, then it should
                                                // end immediately
            {
                score += 2 * myValue;
                break;
